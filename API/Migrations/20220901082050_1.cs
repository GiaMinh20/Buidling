        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paied = table.Column<bool>(type: "INTEGER", nullable: false),
                    DatePaied = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyPaied = table.Column<bool>(type: "INTEGER", nullable: false),
                    RentedDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "TypeItems",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "2PN 1VS" });

            migrationBuilder.InsertData(
                table: "TypeItems",
                columns: new[] { "Id", "Name" },
                values: new object[] { 3, "2PN 2VS" });

            migrationBuilder.InsertData(
                table: "TypeItems",
                columns: new[] { "Id", "Name" },
                values: new object[] { 4, "3PN 2VS" });
