        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentRequests_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentRequests_Users_RenterId",
                        column: x => x.RenterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnRentRequests_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UnRentRequests_Users_RenterId",
                        column: x => x.RenterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "35f3e1e4-6519-48f3-b276-e8d3c6db9aca", "Member", "MEMBER" },
                    { 2, "ba134027-9322-4d8b-8b2e-0f83feb7b8aa", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnRentRequests_ItemId",
                table: "UnRentRequests",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_UnRentRequests_RenterId",
                table: "UnRentRequests",
                column: "RenterId");
